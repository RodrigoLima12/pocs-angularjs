        ...
        .run([
            ...
            function ($templateCache) {
                $templateCache.put('template/treeGrid/treeGrid.html',
                    "<div>\n" +
                    " <table class=\"table tree-grid tree-recibos-de-pagamentos nsj-table bulk-actions btns-actions\">\n" +
                    "   <thead>\n" +
                    "     <tr>\n" +
                    ...
                    "       <td class=\"tree-view\"><a ng-click=\"user_clicks_branch(row.branch)\"><i ng-if=\"row.branch.children.length > 0 \" ng-class=\"row.tree_icon\"\n" +
                    ...
                    "       </td>\n" +
                    "       <td class=\"tree-view\" ng-repeat=\"col in colDefinitions\">\n" +
            ...
            function ($timeout,
                ...
                return {
                    ...
                    link: function (scope, element, attrs) {
                        ...
                        var on_expandTo_change = function () {
